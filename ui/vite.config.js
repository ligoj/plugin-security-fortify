...
export default defineConfig({
  ...
  build: {
    ...
    outDir: resolve(__dirname, '../src/main/resources/META-INF/resources/webjars/security-fortify/vue'),
    emptyOutDir: true,
    rollupOptions: {
  ...
  server: { port: 5313, proxy: { '/rest': { target: 'http://localhost:8080', changeOrigin: true }, '/webjars': { target: 'http://localhost:8080', changeOrigin: true } } },
